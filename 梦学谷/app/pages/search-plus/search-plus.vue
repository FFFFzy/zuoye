<template>
	<view>
		...
		<div class="sort">
			<p>
				综合排序
				<img src="/static/fonticon/xiajianto.png" alt="" />
			</p>
			<p>
				全部课程
				<img src="/static/fonticon/xiajianto.png" alt="" />
		...
		<div class="content">
			<div class="hot-content" v-for="(item, index) in searchdata" :key="index">
				<div class="img-box"><img :src="item.mainImage" alt="" /></div>
				<div class="text">
					<h5>{{ item.title }}</h5>
					<p>
						<span class="head"><img src="/static/fonticon/touxiang.png" alt="" /></span>
						<span class="name">{{ item.nickName }}</span>
					</p>
					<p>
						<span class="price">
							<img src="/static/fonticon/qiandai.png" alt="" />
							免费
						</span>
						<span>
							<img src="/static/fonticon/kaishi.png" alt="" />
							{{ item.commTotal }}人在学
						</span>
					</p>
				</div>
